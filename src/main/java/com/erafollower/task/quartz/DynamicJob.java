package com.erafollower.task.quartz;
import com.erafollower.task.enmus.StringUtils;
    ...
    public void execute(JobExecutionContext executorContext) throws JobExecutionException {
        ...
        if (!StringUtils.getStringUtil.isEmpty(jarPath)) {
            ...
            if (jar.exists()) {
                ...
                log.info("Running Job commands : {}  ", StringUtils.getStringUtil.getListString(commands));
                try {
